...
class AddTracksDto {
  @ApiProperty({ type: [String] }) @IsArray() @IsString({ each: true }) youtubeIds: string[];
}
class ReorderDto {
  @ApiProperty({ type: [String] }) @IsArray() @IsString({ each: true }) trackIds: string[];
}
class ImportDto {
  @ApiProperty({ example: 'https://youtube.com/playlist?list=PLxxxx' }) @IsString() youtubeUrl: string;
}
...
export class PlaylistsController {
  ...
  addTracks(@Param('id') id: string, @CurrentUser('id') userId: string, @Body() dto: AddTracksDto) {
  ...
  removeTrack(@Param('id') id: string, @Param('trackId') trackId: string, @CurrentUser('id') userId: string) {
  ...
  reorder(@Param('id') id: string, @CurrentUser('id') userId: string, @Body() dto: ReorderDto) {
